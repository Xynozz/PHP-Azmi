...
<html lang="en">
  ...
  <div class="form-group">
    ...
    <textarea name="alamat" id="" cols="185" rows="5" placeholder="Masukan Alamat"></textarea>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <select name="jurusan" id="" class="form-control">
        <option type="placeholder" value="">Pilih Jurusan</option>
  ...
  <button type="submit" name="daftar" class="btn btn-success border-light">Daftar</button>
</form>
  </div>
</div>
    <!-- /CONTENT -->
